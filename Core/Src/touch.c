...
/*
	屏幕键盘输入数字的读取
	返回值 key_value '0'~'9'代表数字0-9， 'e' 代表确认， 'c'代表 取消， '<'代表 删除
*/
uint8_t keyboard_scan(void)
{
	...
	{	
		...
		{	
			if(tp_dev.x[0] < wide)
			{
				if(tp_dev.y[0] > 320-1*high)
					key_value = '0';
				else if(tp_dev.y[0] > 320-2*high)
					key_value = '1';
				else if(tp_dev.y[0] > 320-3*high)
					key_value = '4';
				else if(tp_dev.y[0] > 320-4*high)
					key_value = '7';
			}
			else if(tp_dev.x[0] < 2*wide)
			{
				if(tp_dev.y[0] > 320-1*high)
					key_value = 'e';
				else if(tp_dev.y[0] > 320-2*high)
			...
			else if(tp_dev.x[0] < lcddev.width)
			{
				if(tp_dev.y[0] > 320-2*high)
					key_value = 'b';
				else if(tp_dev.y[0] > 320-3*high)
					key_value = '<';
				else if(tp_dev.y[0] > 320-4*high)
