...
#define PEN 			HAL_GPIO_ReadPin(T_PEN_GPIO_Port, T_PEN_Pin)
#define DOUT 			HAL_GPIO_ReadPin(T_MISO_GPIO_Port, T_MISO_Pin)
#define TDIN(x) 		HAL_GPIO_WritePin(T_MOSI_GPIO_Port, T_MOSI_Pin, x) 	//T_MOSIHAL
#define TCLK(x) 		HAL_GPIO_WritePin(T_SCK_GPIO_Port, T_SCK_Pin, x)  	//T_SCK
#define TCS(x)  		HAL_GPIO_WritePin(T_CS_GPIO_Port, T_CS_Pin, x)  	//T_CS  
...
uint8_t keyboard_scan(void);					//read number from small keyboard
